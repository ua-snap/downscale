...
def calc_seasonal( season_name, files, output_path, agg_metric, *args, **kwargs ):
	'''
...
def make_decadal_seasonal( base_path, output_path, variable, model, scenario, decade, ncpus, agg_metric ):
	...
	files = sort_files( only_years( files, begin=decade_begin, end=decade_end, split_on='_', elem_year=-1 ) )
...
if __name__ == '__main__':
	...
	for decade in decades:
		...
		_ = make_decadal_seasonal( base_path, output_path, variable, model, scenario, decade, ncpus, agg_metric )
