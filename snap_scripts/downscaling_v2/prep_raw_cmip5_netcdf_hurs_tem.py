...
if __name__ == '__main__':
	...
	# some setup args
	base_dir = '/workspace/Shared/Tech_Projects/DeltaDownscaling/project_data/cmip5/raw_download_rhs/data_raw_sorted'
	prepped_dir = '/workspace/Shared/Tech_Projects/DeltaDownscaling/project_data/cmip5/prepped'
	variables = [ 'hurs' ]
	...
	for variable, model, scenario in itertools.product( variables, models, scenarios ):
		print( 'prepping: {} {} {}'.format( variable, model, scenario ) )
