...
if __name__ == '__main__':
	...
	models = ['ts323'] # [ 'IPSL-CM5A-LR', 'MRI-CGCM3', 'GISS-E2-R', 'GFDL-CM3', 'CCSM4' ]
	scenarios = ['historical'] # [ 'historical', 'rcp26', 'rcp45', 'rcp60', 'rcp85' ]
	template_rst = '/workspace/Shared/Tech_Projects/EPSCoR_Southcentral/project_data/downscaled_cmip5_clipped/CCSM4/historical/tasmax/tasmax_mean_C_ar5_CCSM4_historical_01_1901.tif'
	...
	for variable in variables:
		...
		prefix = '_'.join([ variable, project, 'decadals', '5ModelAvg_diff','summaries', str(begin), str(end) ])
