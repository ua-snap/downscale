...
def run_model( fn, base_dir, variable, model, scenario, units, metric, level=None, level_name=None ):
	...
	script_path = '/workspace/UA/malindgren/repos/downscale/snap_scripts/downscaling_v2/downscale_cmip5_L48.py'
	with open( fn, 'w' ) as f:
		if level != None:
...
if __name__ == '__main__':
	...
	path = os.path.join( base_dir, 'insolation_L48', 'downscaled_L48', 'slurm_log' )
