...
if __name__ == '__main__':
	...
	girr_dir = os.path.join( base_path, 'insolation_L48', 'climatologies', 'girr' )
	...
	path_list = [ os.path.join( base_path, 'insolation_L48', 'downscaled_L48', model, scenario, variable, '*.tif' ) for model in models for variable in variables for scenario in scenarios ]
