...
def crop_clip( shp_fn, rst_fn, out_fn ):
	...
	proj4string = 'EPSG:3581'
	subprocess.call(['gdalwarp', '-multi', '-q', '-overwrite', '-tap','-t_srs', proj4string, '-co', 'COMPRESS=LZW', '-tr', '15000', '15000', 
...
if __name__ == '__main__':
	...
	output_path = '/workspace/Shared/Tech_Projects/DeltaDownscaling/project_data/nwt_aoi_10min'
	ncpus = 16
	subdomain_fn = '/workspace/Shared/Tech_Projects/DeltaDownscaling/project_data/masks/NWT_AOI_EPSG_3581.shp'
