...
if __name__ ==	'__main__':
	...
	# # # TESTING
	# cru_ts = '/Data/Base_Data/Climate/World/CRU_grids/CRU_TS40/cru_ts4.00.1901.2015.pre.dat.nc.gz'
	# clim_path =  '/workspace/Shared/Tech_Projects/DeltaDownscaling/project_data/climatologies/cru_cl20/10min/pre'
	# output_path =  '/workspace/Shared/Tech_Projects/DeltaDownscaling/project_data/downscaled_10min_nwt/ts40/historical/pr'
	# model =  'ts40'
	# variable =  'pre'
	# units =  'mm'
	# metric =  'total'
	...
	# aoi_mask_fn = '/workspace/Shared/Tech_Projects/DeltaDownscaling/project_data/akcan_10min_template/sunp_cru_cl20_akcan_01_1961-1990_GCLL_trim.shp'
