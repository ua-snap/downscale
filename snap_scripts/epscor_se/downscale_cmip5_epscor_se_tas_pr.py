...
if __name__ == '__main__':
	...
	# some setup args
	base_dir = '/workspace/Shared/Tech_Projects/EPSCoR_Southcentral/project_data/prepped_cmip5_tas_pr'
	output_dir = '/workspace/Shared/Tech_Projects/EPSCoR_Southcentral/project_data/downscaled_tas_pr'
	variables = [ variable ]
	scenarios = [ scenario ]
	models = [ model ]
