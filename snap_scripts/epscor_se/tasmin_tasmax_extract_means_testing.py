...
if __name__ == '__main__':
	...
	nc_fn = './tasmax_CCSM4_rcp45_r1i1p1_2006_2100.nc'
	...
	ds_hist = xr.open_dataset( nc_fn_hist ).load() - 273.15
	...
	orig_mean = ds.tasmax.sel( time=slice( str(begin), str(end) ) ).where( ds.mask == 1 ).mean( axis=(1,2) )
