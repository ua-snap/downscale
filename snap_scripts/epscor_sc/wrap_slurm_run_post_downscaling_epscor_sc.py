...
if __name__ == '__main__':
	...
	scripts_directory = '/workspace/UA/malindgren/repos/downscale/snap_scripts/epscor_se'
	ncpus = 32
	# project = 'cru'
	project = 'cmip5'
		...
		for scenario in scenarios:
			for variable in variables:
				...
				for agg_metric in agg_metrics: 
					...
					decadals = ' '.join([ 'python', os.path.join( scripts_directory, 'compute_decadal_grids_epscor_se.py' ), \
					...
					annual_seasonals = ' '.join([ 'python', os.path.join( scripts_directory, 'compute_seasonal_annual_grids_epscor_se.py' ), \
												'-b', base_path, '-o', output_path, '-m', model , '-s', scenario, '-p', project, '-v', variable ,\
												'-am', agg_metric ,'-nc', str(ncpus) ])
					...
					decadal_seasonals = ' '.join([ 'python', os.path.join( scripts_directory, 'compute_seasonal_decadal_grids_epscor_se.py' ), \
					...
					if variable == 'tas':
						...
						decadal_swi = ' '.join([ 'python', os.path.join( scripts_directory, 'swi_calc_decadal_epscor_se.py' ), \
