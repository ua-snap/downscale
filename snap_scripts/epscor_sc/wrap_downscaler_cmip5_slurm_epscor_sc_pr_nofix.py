...
def run_model( fn, base_dir, variable, model, scenario, units, metric ):
	...
	script_path = '/workspace/UA/malindgren/repos/downscale/snap_scripts/epscor_sc/downscale_cmip5_epscor_sc_pr_nofix.py'
	with open( fn, 'w' ) as f:
...
if __name__ == '__main__':
	...
	path = os.path.join( base_dir,'downscaled_pr_nofix','slurm_log' )
