...
def calc_seasonal_mean( season_name, files, output_path, agg_metric, *args, **kwargs ):
	'''
...
def make_seasonals( base_path, output_path, model, scenario, variable, begin, end, ncpus, agg_metric ):
	'''
	...
	args = [ ( season_name, file_group, output_path, agg_metric ) for season_name, file_group in seasons ]
...
if __name__ == '__main__':
	...
	print( 'running: {} {} {}'.format( model, variable, scenario ) )
	_ = make_seasonals( base_path, output_path, model, scenario, variable, begin, end, ncpus, agg_metric )
...
# output_path = '/workspace/Shared/Tech_Projects/EPSCoR_Southcentral/project_data/derived_outputs/annual_seasonal'
# ncpus = 32
# # project = 'cru'
# project = 'cmip5'
...
# 			command = ' '.join([ 'ipython', 'compute_seasonal_annual_grids_epscor_se.py', '--', '-b', base_path, '-o ', output_path, '-m ', model , '-s', scenario, '-p', project, '-v', variable ,'-am', agg_metric ,'-nc', str(ncpus) ])
# 			os.system( command )
