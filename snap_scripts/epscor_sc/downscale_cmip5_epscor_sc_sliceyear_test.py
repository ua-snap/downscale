...
if __name__ == '__main__':
	...
	for variable in variables:
		...
		output_dir = os.path.join( base_dir, 'downscaled_test_ipsl' )
		variables = [ variable ]
		scenarios = [ scenario ]
		models = [ model ]
		...
		for variable, model, scenario in itertools.product( variables, models, scenarios ):
			...
			if 'historical' in scenario:
				...
				future = downscale.Dataset( fn, variable, model, scenario, project=project, units=units, metric=metric, begin=2096, end=2096 )
