...
def run_model( fn, variable, model, scenario ):
	...
	script_path = '/workspace/UA/malindgren/repos/downscale/snap_scripts/epscor_se/downscale_cmip5_epscor_se.py'
	with open( fn, 'w' ) as f:
		command = ' '.join([ 'ipython', script_path,\
							 '--', '-m', model, '-v', variable, '-s', scenario  ])
		f.writelines( head + "\n" + command + '\n' )
...
if __name__ == '__main__':
	...
	path = '/workspace/Shared/Tech_Projects/EPSCoR_Southcentral/project_data/downscaled/slurm_log'
