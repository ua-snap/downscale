...
if __name__ == '__main__':
	...
	output_path = '/workspace/Shared/Tech_Projects/EPSCoR_Southcentral/project_data/downscaled_cmip5_v2_clipped'
	ncpus = 32
	...
	for root, subs, files in os.walk( base_path ):
		if any( [ model in root for model in models ] ) == True:
			if 'derived' not in root and len( [ fn for fn in files if fn.endswith( '.tif' ) ] ) > 0:
