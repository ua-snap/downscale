...
setwd('/workspace/UA/malindgren/repos/downscale/snap_scripts/baseline_climatologies/radiation')
...
rst = raster( fn )
outdir = '/workspace/Shared/Tech_Projects/DeltaDownscaling/project_data/climatologies/other/2km/girr/'
