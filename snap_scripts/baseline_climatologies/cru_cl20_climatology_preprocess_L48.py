...
if __name__ == '__main__':
	...
	variable = 'sunp'
	template_raster_fn = '/workspace/Shared/Tech_Projects/DeltaDownscaling/project_data/insolation_L48/climatologies/girr/girr_w-m2_01.tif'
	# # # # # # # # # # # # #

	# build an output path to store the data generated with this script
	output_path = os.path.join( base_path, variable )
