...
if __name__ == '__main__':
	...
	# filenames
	vap_fn = '/Data/Base_Data/Climate/World/CRU_grids/CRU_TS40/cru_ts4.00.1901.2015.vap.dat.nc.gz'
	tas_fn = '/Data/Base_Data/Climate/World/CRU_grids/CRU_TS40/cru_ts4.00.1901.2015.tmp.dat.nc.gz'
	...
	hur.attrs.update( long_name='relative humidity', 
					units='pct', derived_by='SNAP - 3/14/2017', 
