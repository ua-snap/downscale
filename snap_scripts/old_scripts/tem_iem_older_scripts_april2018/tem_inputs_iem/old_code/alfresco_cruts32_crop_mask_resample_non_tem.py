...
if __name__ == '__main__':
	...
	output_filenames = [ generate_output_fn( input_fn, output_path, group ).replace('_downscaled', '') for input_fn in file_list ]
...
# model = '5modelAvg' #[ 'CCSM4', 'CNRM-CM5', 'GFDL-CM3', 'GISS-E2-R', 'IPSL-CM5A-LR', 'MPI-ESM-LR', 'MRI-CGCM3', '5modelAvg' ]
...
# template_raster_mask_fn = '/workspace/UA/malindgren/projects/ALFRESCO_DATA_CLIP/mask_tmp/AKCanada_PRISM_Mask_1km_ALFRESCO_commonExtent.tif'
# group = 'alf'
...
# # IEM 1km
# output_base_path = '/atlas_scratch/malindgren/CRU/AKCAN_1km'
# template_raster_mask_fn = '/workspace/Shared/Tech_Projects/ALFRESCO_Inputs/project_data/TEM_Data/extents/IEM_Mask_1km.tif'
# group = 'iem'
...
# list the data we want
input_path = '/atlas_scratch/malindgren/downscaled/tem/cru_ts323/AKCAN_2km/vap'
# out = [ root for root, subs, files in os.walk( input_path ) \
# 		if len( glob.glob( os.path.join( root, '*.tif' ) ) ) > 0 and not 'derived' in root ]
# input_paths = np.unique( out ).tolist()

# IEM 1km
output_base_path = '/atlas_scratch/malindgren/downscaled/tem/cru_ts323/IEM_1km'
template_raster_mask_fn = '/workspace/Shared/Tech_Projects/ALFRESCO_Inputs/project_data/TEM_Data/extents/IEM_Mask_1km.tif'
group = 'iem'
...
# 	print input_path
os.chdir( '/workspace/Shared/Tech_Projects/ALFRESCO_Inputs/project_data/CODE/tem_ar5_inputs/downscale_cmip5/bin' )
os.system( 'python alfresco_cruts32_crop_mask_resample_non_tem.py -p ' + input_path + ' -o ' + output_base_path + ' -m ' + template_raster_mask_fn + ' -g ' + group )

# AKCAN 1km
output_base_path = '/atlas_scratch/malindgren/downscaled/tem/cru_ts323/AKCAN_1km'
template_raster_mask_fn = '/workspace/UA/malindgren/projects/ALFRESCO_DATA_CLIP/mask_tmp/AKCanada_PRISM_Mask_1km_ALFRESCO_commonExtent.tif'
group = 'alf'
