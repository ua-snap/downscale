...
# a line must be written in here that will allow for a pclatlong conversion from the standard greenwich that cru ts20 is in.
if(any(sunp[,2]<0)) sunp[,2] <- sunp[,2]+180
